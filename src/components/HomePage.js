...
// In your HomePage.jsx, update the admin button handler:
const handleAdminClick = () => navigate('/admin/login'); // Changed to admin-specific login
    ...
    <div className="font-sans bg-gray-100">
      <header className="header">
        ...
        <nav className="nav-links">
          ...
          <button onClick={handleAdminClick} className="nav-button admin-link">لوحة التحكم</button> {/* Added admin button */}
        </nav>
