...
const genrateBotResponse = async (incomingMessageDiv) => {
    ...
    let apiResponseText = "Oops! Something went wrong. Please try again."; // ← عرّف المتغير هنا
    ...
    try {
        ...
        console.log(error);
        apiResponseText = error.message || "Unexpected error occurred!";
    } finally {
...
messageInput.addEventListener("keydown",(e) =>{
    const userMesssage= e.target.value.trim();
    if(e.key === "Enter" && userMesssage){
